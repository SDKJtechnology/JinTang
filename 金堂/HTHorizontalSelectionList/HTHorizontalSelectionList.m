...
- (void)commonInit {
    ...
    _titleFont = [NSMutableDictionary dictionaryWithDictionary:@{@(UIControlStateNormal) : [UIFont systemFontOfSize:13]}];
...
- (CGSize)collectionView:(UICollectionView *)collectionView
  ...
  sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.dataSource respondsToSelector:@selector(selectionList:viewForItemWithIndex:)]) {
        ...
        NSInteger cont = [self.dataSource numberOfItemsInSelectionList:self];
        
        CGFloat width = [self superview].frame.size.width / cont - kHTHorizontalSelectionListLabelCellInternalPadding + self.selectionIndicatorHorizontalPadding;
