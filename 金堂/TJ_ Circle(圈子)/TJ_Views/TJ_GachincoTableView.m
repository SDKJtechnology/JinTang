...
{
    NSString *identifier = [TJ_CommentTableViewCell identifierForModelAtRow:[[GachincoModel alloc] init:indexPath.row ]];
    TJ_CommentTableViewCell *cell = nil;
    cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    if (!cell) {
        cell = [[TJ_CommentTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
