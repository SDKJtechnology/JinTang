...
@interface TJSelectionList()<UIScrollViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
{
    NSInteger items;
    CGFloat itemWidth;
...
@implementation TJSelectionList
...
- (void)layoutSubviews
{
    [self.collectionView registerClass:[TJSelectionListCell class] forCellWithReuseIdentifier:identifier];
...
{
    TJSelectionListCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:identifier forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didDeselectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ((TJSelectionListCell *)cell).seletedTitleColor = [UIColor grayColor];
    ((TJSelectionListCell *)cell).indicatorColor = [UIColor clearColor];
}
...
- (void)reloadItemState:(NSIndexPath *)indexPath
{
    ...
    ((TJSelectionListCell *)cell).seletedTitleColor = [UIColor blackColor];
    ((TJSelectionListCell *)cell).indicatorColor = [UIColor blueColor];
